...
urlpatterns = [
    ...
    path('cio/', CIOview.as_view(), name='cio_view'),
    path('sot_view/', SOTView.as_view(), name='sot_view'),
    path('config_mgmt/', ConfigManagement.as_view(), name='config_mgmt'),
    path('catalog/', NWCatelog.as_view(), name='nw_catalog'),
    path('digital-twin/', DigitalTwin.as_view(), name='digital_twin'),
    path('genai/', GenAI.as_view(), name='genai'),
    path('integration/', Integration.as_view(), name='integration'),
    path('health/', HealthDashboard.as_view(), name='health_dashboard'),
